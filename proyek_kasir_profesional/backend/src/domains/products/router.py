...
# # PERBAIKAN: Impor dependensi untuk otentikasi
from src.core.dependencies import require_role

router = APIRouter(
    prefix="/products",
    tags=["Products"],
    # # PERBAIKAN: Tambahkan dependensi di tingkat router
    # # Ini akan melindungi SEMUA endpoint produk, mengharuskan login.
...
# # PERBAIKAN: Tambahkan endpoint DELETE yang hilang
