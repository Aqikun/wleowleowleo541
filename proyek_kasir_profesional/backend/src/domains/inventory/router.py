# backend/src/domains/inventory/router.py
...
@router.post("/suppliers/", response_model=schemas.Supplier, status_code=status.HTTP_201_CREATED, tags=["Inventory - Suppliers"])
...
@router.get("/suppliers/", response_model=List[schemas.Supplier], tags=["Inventory - Suppliers"])
...
@router.get("/suppliers/{supplier_id}", response_model=schemas.Supplier, tags=["Inventory - Suppliers"])
...
@router.put("/suppliers/{supplier_id}", response_model=schemas.Supplier, tags=["Inventory - Suppliers"])
...
@router.delete("/suppliers/{supplier_id}", response_model=schemas.Supplier, tags=["Inventory - Suppliers"])
...
@router.post("/purchase-orders/", response_model=schemas.PurchaseOrder, status_code=status.HTTP_201_CREATED, tags=["Inventory - Purchase Orders"])
...
@router.get("/purchase-orders/", response_model=List[schemas.PurchaseOrder], tags=["Inventory - Purchase Orders"])
...
@router.get("/purchase-orders/{po_id}", response_model=schemas.PurchaseOrder, tags=["Inventory - Purchase Orders"])
